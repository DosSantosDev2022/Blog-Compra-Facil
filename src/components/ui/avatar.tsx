...
>(({ className, ...props }, ref) => (
	<span
		ref={ref}
		className={twMerge(
			'truncate text-sm font-semibold dark:text-foreground text-primary-foreground ',
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<span
		ref={ref}
		className={twMerge(
			'truncate text-xs font-normal dark:text-foreground/80 text-primary-foreground/80',
			className,
		)}
		{...props}
	/>
